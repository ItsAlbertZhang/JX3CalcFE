...
// import { DataInput, TypeQueryDPS, TypeString } from "@/components/definitions";
...
// const getNewUserinput = (userinput: DataInput, attr: string) => {
//     switch (attr) {
//         case "基础":
//             return {
//                 ...userinput,
...
//             const response = (await createTask(newuserinput)) as TypeString;
//             if (response.status === 0) {
//                 const id = response.data;
//                 let complete = false;
//                 while (!complete) {
//                     await new Promise((resolve) => setTimeout(resolve, 1000));
//                     const response = (await queryDps(id)) as TypeQueryDPS;
//                     if (response.status === 0) {
